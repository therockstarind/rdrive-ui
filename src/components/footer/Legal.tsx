  ...
  return (
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <Listbox aria-label="Legal Links"  className="mt-2">
        <ListboxItem key="A" endContent="A" href="/about">About Us</ListboxItem>
        <ListboxItem key="P" endContent="P" href="/privacy">Privacy Policy</ListboxItem>
        <ListboxItem key="T" endContent="T" showDivider href="/terms">Terms of Service</ListboxItem>
        <ListboxItem key="F" className="text-primary" color="secondary" endContent="F" href="">
            Report & Feedback
        </ListboxItem>
      </Listbox>
      </DrawerContent>
